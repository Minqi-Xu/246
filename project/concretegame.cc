...
ConcreteGame::ConcreteGame() {
    ...
    auto p0 = new std::vector<std::string>;
    table.emplace_back(p0);
    auto p1 = new std::vector<std::string>;
    table.emplace_back(p1);
    auto p2 = new std::vector<std::string>;
    table.emplace_back(p2);
    auto p3 = new std::vector<std::string>;
    table.emplace_back(p3);
